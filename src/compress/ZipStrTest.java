...
public class ZipStrTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ys = ZipUtil.gzip(str);
        System.out.println("\ngzip 压缩后的字符串为----->" + ys);
        float len1=ys.length();
        System.out.println("gzip 压缩后的字符串长度为----->" + len1);


        String jy = ZipUtil.gunzip(ys);
        System.out.println("\ngunzip 解压缩后的字符串为--->" + jy);
        System.out.println("解压缩后的字符串长度为--->"+jy.length());

        System.out.println("\ngzip 压缩比例为"+len1/len0);
        System.out.println("###############################################################");
        System.out.println("###############################################################");
        System.out.println("###############################################################");


        String ys2 = ZipUtil.zip(str);
        System.out.println("\nzip 压缩后的字符串为----->" + ys);
        float len2=ys.length();
        System.out.println("zip 压缩后的字符串长度为----->" + len1);

        String jy2 = ZipUtil.unzip(ys2);
        System.out.println("\nunzip 解压缩后的字符串为--->" + jy2);
        System.out.println("解压缩后的字符串长度为--->"+jy2.length());
        ...
        JSONArray mArr = JSON.parseArray(str);
