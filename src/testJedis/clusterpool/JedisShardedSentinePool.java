 ...
 * @date 2016/11/7
 */
public class JedisShardedSentinePool extends Pool<ShardedJedis> {
    ...
    public JedisShardedSentinePool(List<String> masters, Set<String> sentinels) {
        this(masters, sentinels, new GenericObjectPoolConfig(),
                Protocol.DEFAULT_TIMEOUT, null, Protocol.DEFAULT_DATABASE);
    }

    public JedisShardedSentinePool(List<String> masters, Set<String> sentinels, String password) {
        this(masters, sentinels, new GenericObjectPoolConfig(),
                Protocol.DEFAULT_TIMEOUT, password);
    }

    public JedisShardedSentinePool(final GenericObjectPoolConfig poolConfig, List<String> masters, Set<String> sentinels) {
    ...
    private HostAndPort toHostAndPort(List<String> getMasterHostByNameResult) {
        String host = getMasterHostByNameResult.get(0);
        int port = Integer.parseInt(getMasterHostByNameResult.get(1));
